...
paredit.core.loc_GT_loc = (function loc_GT_loc(l1,l2){if((new cljs.core.Keyword(null,"line","line",1017226086).call(null,l1) > new cljs.core.Keyword(null,"line","line",1017226086).call(null,l2)))
{return true;
} else
...
paredit.core.move_loc_line = (function move_loc_line(ed,loc,dir){if(cljs.core.truth_(loc))
...
paredit.core.move_loc = (function move_loc(ed,loc,dir){if(cljs.core.truth_(loc))
...
{return paredit.core.move_loc_line.call(null,ed,loc,new cljs.core.Keyword(null,"up","up",1013907981));
} else
{if((new cljs.core.Keyword(null,"ch","ch",1013907415).call(null,neue) >= len))
{return paredit.core.move_loc_line.call(null,ed,loc,new cljs.core.Keyword(null,"down","down",1016993812));
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{return neue;
} else
...
paredit.core.within_range = (function within_range(p__5616,cur){var vec__5618 = p__5616;var start = cljs.core.nth.call(null,vec__5618,0,null);var end = cljs.core.nth.call(null,vec__5618,1,null);var and__3941__auto__ = (end >= new cljs.core.Keyword(null,"line","line",1017226086).call(null,cur));if(and__3941__auto__)
...
paredit.core.string_BAR_comment_QMARK_ = (function string_BAR_comment_QMARK_(ed,cur,allow_strings_QMARK_){var type = lt.objs.editor.__GT_token_type.call(null,ed,lt.objs.editor.adjust_loc.call(null,cur,1));if(cljs.core.truth_(type))
...
{var ch = cljs.core.get.call(null,line,new cljs.core.Keyword(null,"ch","ch",1013907415).call(null,cur));var next_loc = paredit.core.move_loc.call(null,ed,cur,dir);var next_line = ((cljs.core.not_EQ_.call(null,new cljs.core.Keyword(null,"line","line",1017226086).call(null,cur),new cljs.core.Keyword(null,"line","line",1017226086).call(null,next_loc)))?lt.objs.editor.line.call(null,ed,new cljs.core.Keyword(null,"line","line",1017226086).call(null,next_loc)):line);var valid_QMARK_ = cljs.core.not.call(null,paredit.core.string_BAR_comment_QMARK_.call(null,ed,cur,allow_strings_QMARK_));var stackable_QMARK_ = cljs.core.not.call(null,paredit.core.string_BAR_comment_QMARK_.call(null,ed,cur));if(cljs.core.truth_((function (){var and__3941__auto__ = allow_end_QMARK_;if(cljs.core.truth_(and__3941__auto__))
...
{return cljs.core.not_EQ_.call(null,ch,paredit.core.opposites.call(null,cljs.core.last.call(null,stack)));
} else
{return and__3941__auto____$3;
}
} else
...
{var and__3941__auto____$1 = stackable_QMARK_;if(and__3941__auto____$1)
{return cljs.core._EQ_.call(null,ch,paredit.core.opposites.call(null,cljs.core.last.call(null,stack)));
} else
{return and__3941__auto____$1;
}
} else
...
paredit.core.form_boundary = (function form_boundary(ed,loc,regex){var vec__5629 = paredit.core.paired_scan.call(null,cljs.core.with_meta(cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null,"dir","dir",1014003711),new cljs.core.Keyword(null,"left","left",1017222009),new cljs.core.Keyword(null,"ed","ed",1013907473),ed,new cljs.core.Keyword(null,"only-for?","only-for?",1260514697),regex,new cljs.core.Keyword(null,"loc","loc",1014011570),paredit.core.move_loc.call(null,ed,loc,new cljs.core.Keyword(null,"left","left",1017222009)),new cljs.core.Keyword(null,"for","for",1014005819),(function (){var or__3943__auto__ = regex;if(cljs.core.truth_(or__3943__auto__))
{return or__3943__auto__;
} else
{return paredit.core.form_start;
}
})()], true),cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null,"end-line","end-line",2693041432),139,new cljs.core.Keyword(null,"end-column","end-column",3799845882),59], true)));var c = cljs.core.nth.call(null,vec__5629,0,null);var start = cljs.core.nth.call(null,vec__5629,1,null);var vec__5630 = ((cljs.core.not.call(null,c))?cljs.core.with_meta(cljs.core.PersistentVector.fromArray([null,null], true),cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null,"end-line","end-line",2693041432),141,new cljs.core.Keyword(null,"end-column","end-column",3799845882),27], true)):paredit.core.paired_scan.call(null,cljs.core.with_meta(cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null,"dir","dir",1014003711),new cljs.core.Keyword(null,"right","right",1122416014),new cljs.core.Keyword(null,"ed","ed",1013907473),ed,new cljs.core.Keyword(null,"loc","loc",1014011570),paredit.core.move_loc.call(null,ed,start,new cljs.core.Keyword(null,"right","right",1122416014)),new cljs.core.Keyword(null,"for","for",1014005819),cljs.core.re_pattern.call(null,[cljs.core.str("[\\"),cljs.core.str(paredit.core.opposites.call(null,c)),cljs.core.str("]")].join(''))], true),cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null,"end-line","end-line",2693041432),145,new cljs.core.Keyword(null,"end-column","end-column",3799845882),80], true))));var c__$1 = cljs.core.nth.call(null,vec__5630,0,null);var end = cljs.core.nth.call(null,vec__5630,1,null);return cljs.core.with_meta(cljs.core.PersistentVector.fromArray([start,end], true),cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null,"end-line","end-line",2693041432),146,new cljs.core.Keyword(null,"end-column","end-column",3799845882),15], true));
});

paredit.core.escaped_paired_scan = (function escaped_paired_scan(ed,loc,thing,dir){var vec__5632 = paredit.core.paired_scan.call(null,cljs.core.with_meta(cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null,"dir","dir",1014003711),dir,new cljs.core.Keyword(null,"ed","ed",1013907473),ed,new cljs.core.Keyword(null,"allow-strings?","allow-strings?",1208165235),true,new cljs.core.Keyword(null,"loc","loc",1014011570),paredit.core.move_loc.call(null,ed,loc,dir),new cljs.core.Keyword(null,"negation","negation",1935015639),(function (line,loc__$1){return cljs.core.not_EQ_.call(null,cljs.core.get.call(null,line,lt.objs.editor.adjust_loc.call(null,loc__$1,-1)),"\\");
...
paredit.core.first_non_whitespace = (function first_non_whitespace(opts){return paredit.core.scan.call(null,cljs.core.assoc.call(null,opts,new cljs.core.Keyword(null,"regex","regex",1122296761),/\S/));
});

paredit.core.anchored_move = (function anchored_move(ed,loc,anchor_side,dir){var vec__5637 = paredit.core.form_boundary.call(null,ed,loc);var start = cljs.core.nth.call(null,vec__5637,0,null);var end = cljs.core.nth.call(null,vec__5637,1,null);var ends = ((cljs.core._EQ_.call(null,dir,new cljs.core.Keyword(null,"left","left",1017222009)))?paredit.core.form_start:paredit.core.form_end);var point = ((cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"left","left",1017222009),anchor_side))?start:end);var vec__5638 = paredit.core.first_non_whitespace.call(null,cljs.core.with_meta(cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null,"ed","ed",1013907473),ed,new cljs.core.Keyword(null,"loc","loc",1014011570),paredit.core.move_loc.call(null,ed,point,dir),new cljs.core.Keyword(null,"dir","dir",1014003711),dir], true),cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null,"end-line","end-line",2693041432),186,new cljs.core.Keyword(null,"end-column","end-column",3799845882),48], true)));var cur = cljs.core.nth.call(null,vec__5638,0,null);var i = cljs.core.nth.call(null,vec__5638,1,null);var next = (cljs.core.truth_(cur)?(cljs.core.truth_(cljs.core.re_seq.call(null,ends,cur))?null:(cljs.core.truth_(paredit.core.opposites.call(null,cur))?(function (){var right_QMARK_ = cljs.core._EQ_.call(null,dir,new cljs.core.Keyword(null,"right","right",1122416014));var bounds = paredit.core.form_boundary.call(null,ed,((right_QMARK_)?paredit.core.move_loc.call(null,ed,i,dir):i));if(right_QMARK_)
...
paredit.core.shrink = (function shrink(p__5644,anchor_side){var map__5648 = p__5644;var map__5648__$1 = ((cljs.core.seq_QMARK_.call(null,map__5648))?cljs.core.apply.call(null,cljs.core.hash_map,map__5648):map__5648);var orig = map__5648__$1;var loc = cljs.core.get.call(null,map__5648__$1,new cljs.core.Keyword(null,"loc","loc",1014011570));var ed = cljs.core.get.call(null,map__5648__$1,new cljs.core.Keyword(null,"ed","ed",1013907473));var dir = paredit.core.dir_swap.call(null,anchor_side);var map__5649 = paredit.core.anchored_move.call(null,ed,loc,anchor_side,dir);var map__5649__$1 = ((cljs.core.seq_QMARK_.call(null,map__5649))?cljs.core.apply.call(null,cljs.core.hash_map,map__5649):map__5649);var anchor_move = map__5649__$1;var boundary = cljs.core.get.call(null,map__5649__$1,new cljs.core.Keyword(null,"boundary","boundary",3193559964));var point = cljs.core.get.call(null,map__5649__$1,new cljs.core.Keyword(null,"point","point",1120749826));var next = cljs.core.get.call(null,map__5649__$1,new cljs.core.Keyword(null,"next","next",1017282149));var format_side = ((cljs.core._EQ_.call(null,anchor_side,new cljs.core.Keyword(null,"right","right",1122416014)))?cljs.core.second.call(null,boundary):cljs.core.first.call(null,boundary));var neue_point = ((cljs.core._EQ_.call(null,anchor_side,new cljs.core.Keyword(null,"left","left",1017222009)))?cljs.core.second.call(null,next):cljs.core.first.call(null,next));var vec__5650 = (cljs.core.truth_(neue_point)?paredit.core.first_non_whitespace.call(null,cljs.core.with_meta(cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null,"ed","ed",1013907473),ed,new cljs.core.Keyword(null,"loc","loc",1014011570),paredit.core.move_loc.call(null,ed,neue_point,dir),new cljs.core.Keyword(null,"dir","dir",1014003711),dir], true),cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null,"end-line","end-line",2693041432),240,new cljs.core.Keyword(null,"end-column","end-column",3799845882),72], true))):null);var _ = cljs.core.nth.call(null,vec__5650,0,null);var neue_point__$1 = cljs.core.nth.call(null,vec__5650,1,null);var neue_point__$2 = (cljs.core.truth_((function (){var and__3941__auto__ = neue_point__$1;if(cljs.core.truth_(and__3941__auto__))
...
paredit.core.select = (function select(p__5651,type){var map__5654 = p__5651;var map__5654__$1 = ((cljs.core.seq_QMARK_.call(null,map__5654))?cljs.core.apply.call(null,cljs.core.hash_map,map__5654):map__5654);var orig = map__5654__$1;var loc = cljs.core.get.call(null,map__5654__$1,new cljs.core.Keyword(null,"loc","loc",1014011570));var ed = cljs.core.get.call(null,map__5654__$1,new cljs.core.Keyword(null,"ed","ed",1013907473));var vec__5655 = paredit.core.form_boundary.call(null,ed,loc,(cljs.core.truth_(type)?cljs.core.re_pattern.call(null,[cljs.core.str("[\\"),cljs.core.str(type),cljs.core.str("]")].join('')):null));var start = cljs.core.nth.call(null,vec__5655,0,null);var end = cljs.core.nth.call(null,vec__5655,1,null);if(cljs.core.truth_((function (){var and__3941__auto__ = start;if(cljs.core.truth_(and__3941__auto__))
{return end;
} else
{return and__3941__auto__;
}
...
{var e = cljs.core.first.call(null,seq__5663__$1);paredit.core.do_edit.call(null,e,ed);
{
...
cljs.core._add_method.call(null,paredit.core.do_edit,new cljs.core.Keyword(null,"format","format",4040092521),(function (p__5675,ed){var map__5676 = p__5675;var map__5676__$1 = ((cljs.core.seq_QMARK_.call(null,map__5676))?cljs.core.apply.call(null,cljs.core.hash_map,map__5676):map__5676);var to = cljs.core.get.call(null,map__5676__$1,new cljs.core.Keyword(null,"to","to",1013907949));var from = cljs.core.get.call(null,map__5676__$1,new cljs.core.Keyword(null,"from","from",1017056028));if(cljs.core.truth_(paredit.core.loc_GT_loc.call(null,to,from)))
...
{var ed = temp__4092__auto__;return paredit.core.batched_edits.call(null,paredit.core.grow.call(null,paredit.core.ed__GT_info.call(null,ed),new cljs.core.Keyword(null,"right","right",1122416014)));
} else
{return null;
}
...
{var ed = temp__4092__auto__;return paredit.core.batched_edits.call(null,paredit.core.grow.call(null,paredit.core.ed__GT_info.call(null,ed),new cljs.core.Keyword(null,"left","left",1017222009)));
} else
{return null;
}
...
{var ed = temp__4092__auto__;return paredit.core.batched_edits.call(null,paredit.core.shrink.call(null,paredit.core.ed__GT_info.call(null,ed),new cljs.core.Keyword(null,"right","right",1122416014)));
} else
{return null;
}
...
{var ed = temp__4092__auto__;return paredit.core.batched_edits.call(null,paredit.core.shrink.call(null,paredit.core.ed__GT_info.call(null,ed),new cljs.core.Keyword(null,"left","left",1017222009)));
} else
{return null;
}
...
{}
return paredit.core.batched_edits.call(null,paredit.core.select.call(null,paredit.core.ed__GT_info.call(null,ed),type));
} else
{return null;
}
